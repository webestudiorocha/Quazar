...
$useruploadfolder = "giletta%20deportes/sitio/archivos/image";
$useruploadpath = $usersiteroot."$useruploadfolder/";
$foldershistory[] = "giletta%20deportes/sitio/archivos/image";


$useruploadfolder = "giletta deportes/sitio/archivos/image";
$useruploadpath = $usersiteroot."$useruploadfolder/";
$foldershistory[] = "giletta deportes/sitio/archivos/image";


        $useruploadfolder = "antun/pagina_antun/archivos/image";
        $useruploadpath = $usersiteroot."$useruploadfolder/";
        $foldershistory[] = "antun/pagina_antun/archivos/image";
        

        $useruploadfolder = "karikal/archivos/image";
        $useruploadpath = $usersiteroot."$useruploadfolder/";
        $foldershistory[] = "karikal/archivos/image";
        

        $useruploadfolder = "portal%20del%20sol/sitio/archivos/image";
        $useruploadpath = $usersiteroot."$useruploadfolder/";
        $foldershistory[] = "portal%20del%20sol/sitio/archivos/image";
        

        $useruploadfolder = "portal del sol/sitio/archivos/image";
        $useruploadpath = $usersiteroot."$useruploadfolder/";
        $foldershistory[] = "portal del sol/sitio/archivos/image";
        

        $useruploadfolder = "24cedo/site/archivos/image";
        $useruploadpath = $usersiteroot."$useruploadfolder/";
        $foldershistory[] = "24cedo/site/archivos/image";
        

        $useruploadfolder = "archivos/image";
        $useruploadpath = $usersiteroot."$useruploadfolder/";
        $foldershistory[] = "archivos/image";
        

        $useruploadfolder = "http://192.168.88.211/gatti/gatti/archivos";
        $useruploadpath = $usersiteroot."$useruploadfolder/";
        $foldershistory[] = "http://192.168.88.211/gatti/gatti/archivos";
        

        $useruploadfolder = "../archivos";
        $useruploadpath = $usersiteroot."$useruploadfolder/";
